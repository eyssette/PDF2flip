document.addEventListener("DOMContentLoaded", (event) => {
    ...
    shareBtn.addEventListener('click', function () {
        ...
        const confirmation = confirm("Votre lien a été copié dans le presse-papier. Cliquez sur “OK” pour que ce lien affiche seulement le flipbook sans l'interface.");
